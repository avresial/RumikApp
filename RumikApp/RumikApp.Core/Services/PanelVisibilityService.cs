...
namespace RumikApp.Core.Services
{
    public class PanelVisibilityService : ViewModelBase, IPanelVisibilityService
    {
        ...
        public Visibility WelcomePanelVisibility
        {
            get { return _WelcomePanelVisibility; }
            set
            {
                if (_WelcomePanelVisibility == value)
                    return;

                if (value == Visibility.Visible)
                    collapseAllViews();

                _WelcomePanelVisibility = value;
                RaisePropertyChanged(nameof(WelcomePanelVisibility));
            }
        }
